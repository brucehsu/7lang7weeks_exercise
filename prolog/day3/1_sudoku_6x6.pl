valid_different([]).
valid_different([Head|Tail]) :- fd_all_different(Head), valid_different(Tail).
sudoku(Given, Solution) :- Solution = Given,
Given = [S11, S12, S13, S14, S15, S16,
...
valid_different([Row1, Row2, Row3, Row4, Row5, Row6, Col1, Col2, Col3, Col4, Col5, Col6, Square1, Square2, Square3, Square4, Square5, Square6]).